import svgPaths from "./svg-qj1idrm187";
    ...
    <div className="absolute h-[684px] left-[292px] top-[566px] w-[1216px]">
      <div className="absolute h-[684px] left-0 rounded-[12px] top-0 w-[1216px]" data-name="image 10">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[12px]">
          <img alt="" className="absolute h-[103.8%] left-[-7.05%] max-w-none top-0 w-[110.07%]" src="7d34e084a7c1b70cc76b2a48a33f878bcadd73c6.png" />
        </div>
      </div>
    </div>
  );
...
function Frame32() {
  return (
    <div className="absolute h-[684px] left-[292px] top-[3001px] w-[1216px]">
      <div className="absolute h-[684px] left-0 rounded-[12px] top-0 w-[1216px]" data-name="image 10">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[12px]">
          <img alt="" className="absolute h-[101.69%] left-[-3.71%] max-w-none top-[-1.1%] w-[107.92%]" src="7d34e084a7c1b70cc76b2a48a33f878bcadd73c6.png" />
        </div>
      </div>
    </div>
  );
...
function Frame33() {
  return (
    <div className="absolute h-[684px] left-[292px] top-[4078px] w-[1216px]">
      <div className="absolute h-[684px] left-0 rounded-[12px] top-0 w-[1216px]" data-name="image 10">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[12px] size-full" src="ceee1ba919094273d30c01d1694afcfe4c01a9ec.png" />
      </div>
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="absolute h-[684px] left-[292px] top-[5181px] w-[1216px]">
      <div className="absolute h-[684px] left-0 rounded-[12px] top-0 w-[1216px]" data-name="image 10">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[12px]">
          <img alt="" className="absolute h-[129.75%] left-0 max-w-none top-[-12.36%] w-full" src="f10a5281c68bdcf64e9e807c23cc4363a06f9713.png" />
        </div>
      </div>
...
function Frame6() {
  return (
    <div className="absolute bg-[#2f2f2f] bottom-0 box-border content-stretch flex flex-col gap-[10px] items-center left-0 px-[32px] py-[16px] w-[1800px]">
      <Frame4 />
    </div>
  );
}
...
export default function Component1280() {
  return (
    <div className="bg-[#1a1a1a] relative size-full" data-name="+1280">
      <Frame35 />
